...
pathDir = r"C:\Users\keven\OneDrive - University of Nebraska at Omaha\Spring 2022\Big Data\final_project\Datasets\Original\equal_split"
# Destination you desire to copy the files.
targetPath = r"C:\Users\keven\OneDrive - University of Nebraska at Omaha\Spring 2022\Big Data\final_project\Datasets\Original\equal_split_subsets"
#%%
try:
    # Sub Directories
...
for FileName in trainSet:
    copyfile(
        os.path.join(SOURCE, FileName[1], FileName[0]),
        os.path.join(targetPath, allocation[0], FileName[1], FileName[0]),
    )
#%% Development Set
for FileName in devSet:
    copyfile(
        os.path.join(SOURCE, FileName[1], FileName[0]),
        os.path.join(targetPath, allocation[1], FileName[1], FileName[0]),
    )
#%% Test Set
for FileName in testSet:
    copyfile(
        os.path.join(SOURCE, FileName[1], FileName[0]),
        os.path.join(targetPath, allocation[2], FileName[1], FileName[0]),
    )
